...
describe("staged Pi user-journeys contract", () => {
  ...
  it("accepts a milestone that also lands somewhere the journey continues from", () => {
    const mixedPlan = {
      schema_version: 1,
      journey_artifact_hash: "sha256:journey",
      fact_graph_artifact_hash: "sha256:fact",
      ...
      targets: [
        {
          target_ref: "JM001", journey_ref: "J001", journey_kind: "normal", milestone_position: 1,
          phase: "work", required_outcome: "normal", allowed_workflow_refs: ["WF-settings", "WF-mapping"],
          workflow_candidates: [
            { workflow_ref: "WF-settings", eligible_edges: [{ edge_ref: "E-1", from_screen_ref: "SCR-main", to_screen_ref: "SCR-settings", feasibility: "source-supported" }] },
            { workflow_ref: "WF-mapping", eligible_edges: [{ edge_ref: "E-3", from_screen_ref: "SCR-main", to_screen_ref: "SCR-main", feasibility: "source-supported" }] },
          ],
        },
        {
          target_ref: "JM002", journey_ref: "J001", journey_kind: "normal", milestone_position: 2,
    ...
    expect(validateUserJourneyWorkflowLinkPatch({
      ...
      business_workflow_mapping_artifact_hash: "sha256:mapping",
      milestone_links: [
        { target_ref: "JM001", workflow_refs: ["WF-settings", "WF-mapping"] },
        { target_ref: "JM002", workflow_refs: ["WF-result"] },
      ],
      unresolved: [],
    }, mixedPlan)).toEqual([]);
